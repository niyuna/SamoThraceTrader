...
def main():
    ...
    try:
        ...
        strategy.set_strategy_params(
            ...
            gap_up_threshold=0.5 if weekday in [2, 3] else 0.02,      # 2% gap up 
            ...
            max_exit_wait_time_gap_up=40,     # 最大平仓等待时间（分钟）
            max_vol_ma5_ratio_threshold_gap_up=1.2, # Gap Up时的成交量MA5阈值
